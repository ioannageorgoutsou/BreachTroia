...
public class Gate2 extends Gate1 {
		...
		public static String gate2() {
			...
			//displaying message
			System.out.println("You chose the gate as your fourth obstacle. You now have to choose one of the two weapons left to attack: ");
